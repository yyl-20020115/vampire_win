...
class Int
{
 public:
  ...
  static vstring toString(size_t i);
  ...
  { return i1 < i2 ? Comparison::LESS : i1 == i2 ? Comparison::EQUAL : Comparison::GREATER; }
  ...
  { return p1 < p2 ? Comparison::LESS : p1 == p2 ? Comparison::EQUAL : Comparison::GREATER; }
  /** Compare two floats */
  inline static Comparison compare (float f1, float f2)
  { return f1 < f2 ? Comparison::LESS : f1 == f2 ? Comparison::EQUAL : Comparison::GREATER; }
  /** Compare two doubles */
