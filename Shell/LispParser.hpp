...
public:
  ...
  struct Expression {
    ...
    bool isList() const { return tag==Tag::LIST; }
    bool isAtom() const { return tag==Tag::ATOM; }
...
public:
  ...
  {
    _elements.push(new LExpr(LispParser::Tag::ATOM, s));
    return *this;
  }
  ...
  LExpr* get() const
  {
    ...
    LExpr* res = new LExpr(LispParser::Tag::LIST);
    res->list = getList();
    return res;
  }
