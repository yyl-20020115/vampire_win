...
Statistics::Statistics()
  : inputClauses(0),
    ...
    refutation(0),
    saturatedSet(0),
    phase(Shell::Statistics::ExecutionPhase::INITIALIZATION)
{
} // Statistics::Statistics
...
#define SEPARATOR if (separable) { addCommentSignForSZS(out); out << endl; separable = false; }
  ...
  case Statistics::TerminationReason::REFUTATION:
    out << "Refutation";
    break;
  case Statistics::TerminationReason::TIME_LIMIT:
    out << "Time limit";
    break;
  case Statistics::TerminationReason::MEMORY_LIMIT:
    out << "Memory limit";
    break;
  case Statistics::TerminationReason::ACTIVATION_LIMIT:
    out << "Activation limit";
    break;
  case Statistics::TerminationReason::REFUTATION_NOT_FOUND:
    explainRefutationNotFound(out);
    break;
  case Statistics::TerminationReason::SATISFIABLE:
    out << "Satisfiable";
    break;
  case Statistics::TerminationReason::SAT_SATISFIABLE:
    out << "SAT Satisfiable";
    break;
  case Statistics::TerminationReason::SAT_UNSATISFIABLE:
    out << "SAT Unsatisfiable";
    break;
  case Statistics::TerminationReason::UNKNOWN:
    out << "Unknown";
    break;
  case Statistics::TerminationReason::INAPPROPRIATE:
    out << "Inappropriate";
    break;
  default:
    ASSERTION_VIOLATION;
  ...
  out << endl;
  if (phase!=Shell::Statistics::ExecutionPhase::FINALIZATION) {
    addCommentSignForSZS(out);
...
{
  switch(p) {
  case Shell::Statistics::ExecutionPhase::INITIALIZATION:
    return "Initialization";
  case Shell::Statistics::ExecutionPhase::PARSING:
    return "Parsing";
  case Shell::Statistics::ExecutionPhase::PROPERTY_SCANNING:
    return "Property scanning";
  case Shell::Statistics::ExecutionPhase::NORMALIZATION:
    return "Normalization";
  case Shell::Statistics::ExecutionPhase::SINE_SELECTION:
    return "SInE selection";
  case Shell::Statistics::ExecutionPhase::INCLUDING_THEORY_AXIOMS:
    return "Including theory axioms";
  case Shell::Statistics::ExecutionPhase::PREPROCESS_1:
    return "Preprocessing 1";
  case Shell::Statistics::ExecutionPhase::PREDIACTE_DEFINITION_MERGING:
    return "Predicate definition merging";
  case Shell::Statistics::ExecutionPhase::PREDICATE_DEFINITION_INLINING:
    return "Predicate definition inlining";
  case Shell::Statistics::ExecutionPhase::UNUSED_PREDICATE_DEFINITION_REMOVAL:
    return "Unused predicate definition removal";
  case Shell::Statistics::ExecutionPhase::BLOCKED_CLAUSE_ELIMINATION:
    return "Blocked clause elimination";
  case Shell::Statistics::ExecutionPhase::PREPROCESS_2:
    return "Preprocessing 2";
  case Shell::Statistics::ExecutionPhase::NEW_CNF:
    return "NewCNF";
  case Shell::Statistics::ExecutionPhase::NAMING:
    return "Naming";
  case Shell::Statistics::ExecutionPhase::PREPROCESS_3:
    return "Preprocessing 3";
  case Shell::Statistics::ExecutionPhase::CLAUSIFICATION:
    return "Clausification";
  case Shell::Statistics::ExecutionPhase::FUNCTION_DEFINITION_ELIMINATION:
    return "Function definition elimination";
  case Shell::Statistics::ExecutionPhase::INEQUALITY_SPLITTING:
    return "Inequality splitting";
  case Shell::Statistics::ExecutionPhase::EQUALITY_RESOLUTION_WITH_DELETION:
    return "Equality resolution with deletion";
  case Shell::Statistics::ExecutionPhase::EQUALITY_PROXY:
    return "Equality proxy";
  case Shell::Statistics::ExecutionPhase::GENERAL_SPLITTING:
    return "General splitting";
  case Shell::Statistics::ExecutionPhase::SATURATION:
    return "Saturation";
  case Shell::Statistics::ExecutionPhase::FINALIZATION:
    return "Finalization";
  case Shell::Statistics::ExecutionPhase::UNKNOWN_PHASE:
    return "Unknown";
  case Shell::Statistics::ExecutionPhase::PREPROCESSING:
    return "BP Preprocessing ";
  case Shell::Statistics::ExecutionPhase::SOLVING:
    return "Solving with Conflict Resolution";
  case Shell::Statistics::ExecutionPhase::SAT_SOLVING:
	  return "SAT Solving";
  case Shell::Statistics::ExecutionPhase::FMB_PREPROCESSING:
          return "Finite model building preprocessing";
  case Shell::Statistics::ExecutionPhase::FMB_CONSTRAINT_GEN:
          return "Finite model building constraint generation";
  case Shell::Statistics::ExecutionPhase::FMB_SOLVING:
