...
//*********************** Preprocessing  ***********************
    ...
    _unusedPredicateDefinitionRemoval.addProblemConstraint(notWithCat(Property::Category::UEQ));
    ...
    _blockedClauseElimination.addProblemConstraint(notWithCat(Property::Category::UEQ));
...
//*********************** Saturation  ***********************
    ...
    _saturationAlgorithm.setRandomChoices(Or(hasCat(Property::Category::UEQ),atomsLessThan(4000)),{"lrs","discount","otter","inst_gen"});
  ...
  //*********************** Inferences  ***********************
	    ...
	    _binaryResolution.setRandomChoices(And(isRandSat(),saNotInstGen(),Or(hasEquality(),isBfnt(),hasCat(Property::Category::HNE))),{"on"});
    ...
    _unitResultingResolution.setRandomChoices(And(isRandSat(),saNotInstGen(),Or(hasEquality(),isBfnt(),hasCat(Property::Category::HNE))),{"on","off"});
...
//*********************** AVATAR  ***********************
    ...
    _splittingLiteralPolarityAdvice = ChoiceOptionValue<SplittingLiteralPolarityAdvice>(
                                                ...
                                                SplittingLiteralPolarityAdvice::_NONE,
                                                {"false","true","none"});
...
//*********************** SAT solver (used in various places)  ***********************
    ...
    _bfnt.addProblemConstraint(notWithCat(Property::Category::EPR));
...
void Options::randomizeStrategy(Property* prop)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_RAND_OPT);
...
bool Options::complete(const Problem& prb) const
{
  ...
  bool unitEquality = prop.category() == Property::Category::UEQ;
  ...
  if (!hasEquality) {
    ...
    return prop.category() == Property::Category::HNE; // URR is complete for Horn problems
  }
