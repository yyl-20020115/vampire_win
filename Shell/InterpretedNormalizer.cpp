...
public:
  ...
  SuccessorTranslator()
  {
    ...
    _succFun = env.signature->getInterpretingSymbol(Theory::Interpretation::INT_SUCCESSOR);
    _plusFun = env.signature->getInterpretingSymbol(Theory::Interpretation::INT_PLUS);
...
public:
    ...
    _fnTransfs(env.signature->functions())
  {
    ...
    addIneqTransformer(Theory::Interpretation::INT_LESS_EQUAL, 	  Theory::Interpretation::INT_LESS, true, true);
    addIneqTransformer(Theory::Interpretation::INT_GREATER, Theory::Interpretation::INT_LESS, true, false);
    addIneqTransformer(Theory::Interpretation::INT_GREATER_EQUAL, Theory::Interpretation::INT_LESS, false, true);

    addIneqTransformer(Theory::Interpretation::RAT_LESS_EQUAL, Theory::Interpretation::RAT_LESS, true, true);
    addIneqTransformer(Theory::Interpretation::RAT_GREATER, Theory::Interpretation::RAT_LESS, true, false);
    addIneqTransformer(Theory::Interpretation::RAT_GREATER_EQUAL, Theory::Interpretation::RAT_LESS, false, true);

    addIneqTransformer(Theory::Interpretation::REAL_LESS_EQUAL, Theory::Interpretation::REAL_LESS, true, true);
    addIneqTransformer(Theory::Interpretation::REAL_GREATER, Theory::Interpretation::REAL_LESS, true, false);
    addIneqTransformer(Theory::Interpretation::REAL_GREATER_EQUAL, Theory::Interpretation::REAL_LESS, false, true);

    addMinusTransformer(Theory::Interpretation::INT_MINUS, Theory::Interpretation::INT_PLUS, Theory::Interpretation::INT_UNARY_MINUS);
    addMinusTransformer(Theory::Interpretation::RAT_MINUS, Theory::Interpretation::RAT_PLUS, Theory::Interpretation::RAT_UNARY_MINUS);
    addMinusTransformer(Theory::Interpretation::REAL_MINUS, Theory::Interpretation::REAL_PLUS, Theory::Interpretation::REAL_UNARY_MINUS);

    addSuccessorTransformer();

    addRoundingFunctionTransformer(Theory::Interpretation::RAT_QUOTIENT_T, Theory::Interpretation::RAT_QUOTIENT, Theory::Interpretation::RAT_TRUNCATE);
    addRoundingFunctionTransformer(Theory::Interpretation::RAT_QUOTIENT_F, Theory::Interpretation::RAT_QUOTIENT, Theory::Interpretation::RAT_FLOOR);
    addRoundingFunctionTransformer(Theory::Interpretation::REAL_QUOTIENT_T, Theory::Interpretation::REAL_QUOTIENT, Theory::Interpretation::REAL_TRUNCATE);
    addRoundingFunctionTransformer(Theory::Interpretation::REAL_QUOTIENT_F, Theory::Interpretation::REAL_QUOTIENT, Theory::Interpretation::REAL_FLOOR);
...
private:
  ...
  void addSuccessorTransformer()
  {
    ...
    if(!env.signature->haveInterpretingSymbol(Theory::Interpretation::INT_SUCCESSOR)) {
      return; //the symbol to be transformed doesn't exist, so we don't need to worry
    }
...
bool InterpretedNormalizer::isTrivialInterpretation(Interpretation itp)
{
  ...
  case Theory::Interpretation::INT_TO_INT:
  case Theory::Interpretation::RAT_TO_RAT:
  case Theory::Interpretation::REAL_TO_REAL:
