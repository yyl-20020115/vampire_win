...
private:
    ...
    struct AbstractOptionValueCompatator{
      Comparison compare(AbstractOptionValue* o1, AbstractOptionValue* o2)
      {
        ...
        return value < 0 ? Comparison::LESS : (value==0 ? Comparison::EQUAL : Comparison::GREATER);
      }
    };
    ...
    struct OptionValue : public AbstractOptionValue {
        ...
        OptionValue():AbstractOptionValue(),defaultValue(),actualValue(){}
...
DecodeOptionValue() :parent() { AbstractOptionValue::_should_copy=false;}
...
// A Wrapped Constraint takes an OptionValue and a Constraint
    ...
    struct HasPredicates : OptionProblemConstraint{
        bool check(Property*p){
          ...
          return (p->category()==Property::Category::PEQ || p->category()==Property::Category::UEQ);
        }
...
public:
  ...
  void setMemoryLimit(size_t newVal) { _memoryLimit.actualValue =(unsigned int) newVal; }
