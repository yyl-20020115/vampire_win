...
public:
  ...
  InterpolantMinimizer(OptimizationTarget target= OptimizationTarget::OT_WEIGHT, bool noSlicing=false,
...
private:
  ...
  struct UnitInfo
  {
    UnitInfo() : state(UnitState::TRANSPARENT_PARENTS), isRefutation(false),
