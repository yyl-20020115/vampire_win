...
Formula* NNF::ennf (Formula* f, bool polarity)
{
  ...
  case Connective::OR:
	...
	return f;
 	...
 	return new JunctionFormula(c,gs);
      ...
      return new JunctionFormula(c == Connective::AND ? Connective::OR : Connective::AND,gs);
    }
  ...
  case Connective::IMP:
    {
      ...
      return new JunctionFormula(polarity ? Connective::OR : Connective::AND,args);
    }
  ...
  case Connective::XOR:
	...
	return new BinaryFormula(c, ll, rr);
      ...
      return new BinaryFormula(c == Connective::XOR ? Connective::IFF : Connective::XOR, ll, rr);
    }
  ...
  case Connective::EXISTS: 
	...
	return new QuantifiedFormula(c,f->vars(),f->sorts(),gg);
      ...
      return new QuantifiedFormula(c == Connective::EXISTS ? Connective::FORALL : Connective::EXISTS,
				   f->vars(),f->sorts(),gg);
    }
  ...
  case Connective::XOR:
    {
      ...
      if (polarity ? c == Connective::IFF : c == Connective::XOR) {
	// essentially l <=> r
	// replace f by (l => r) & (r => l) and apply NNF to it
	g = new JunctionFormula(Connective::AND,
				new FormulaList(new BinaryFormula(Connective::IMP,l,r),
						new FormulaList(new BinaryFormula(Connective::IMP,r,l))));
      }
      else {
	// essentially l XOR r
	// replace f by (l \/ r) & (~l \/ ~r) and apply NNF to it
	g = new JunctionFormula(Connective::AND,
				new FormulaList(new JunctionFormula(Connective::OR,
								    new FormulaList(l,
										    new FormulaList(r))),
						new FormulaList(new JunctionFormula(Connective::OR,
