...
public:
  ...
  */
  ...
  bool trueInAssignment(SATLiteral lit)
  {
    ...
    VarAssignment desired = lit.polarity() ? VarAssignment::_TRUE : VarAssignment::_FALSE;
    return asgn==desired;
  }
  ...
  bool falseInAssignment(SATLiteral lit)
  {
    ...
    VarAssignment asgn = getAssignment(lit.var());
    VarAssignment desired = lit.polarity() ? VarAssignment::_FALSE: VarAssignment::_TRUE;
    return asgn==desired;
  }  
};
