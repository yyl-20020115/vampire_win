...
public:
  ...
  virtual InfType getType() const { return InfType::PROP_INF; }
...
public:
  ...
  virtual InfType getType() const { return InfType::FO_CONVERSION; }
...
public:
  ...
  virtual InfType getType() const { return InfType::ASSUMPTION; }
};
...
void SATInference::collectFilteredFOPremises(SATClause* cl, Stack<Unit*>& acc, Filter f)
{
  ...
  while (toDo.isNonEmpty()) {
    ...
    ASS(sinf);
    switch(sinf->getType()) {
    case SATInference::InfType::FO_CONVERSION:
      acc.push(static_cast<FOConversionInference*>(sinf)->getOrigin());
      break;
    case SATInference::InfType::ASSUMPTION:
      break;
    case SATInference::InfType::PROP_INF:
    {
