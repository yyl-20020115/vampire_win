...
//protected:
    ...
    static Comparison compare(const LeafData& ld1, const LeafData& ld2)
    {
      ...
      */
      ...
      if(ld1.clause && ld2.clause && ld1.clause!=ld2.clause) {
        ...
        return (ld1.clause->number()<ld2.clause->number()) ? Comparison::LESS : Comparison::GREATER;
      }
      Comparison res;
      if(ld1.literal && ld2.literal && ld1.literal!=ld2.literal) {
        res = (ld1.literal->getId()<ld2.literal->getId())? Comparison::LESS : Comparison::GREATER;
      } else {
        ...
        if (ld1.term.isEmpty()) {
          ...
          if (ld1.term.isVar()) {
            if (ld2.term.isVar()) {
              ...
              res=(var1<var2)? Comparison::LESS : (var1>var2)? Comparison::GREATER : Comparison::EQUAL;
            }
            else{
              res = Comparison::LESS;
            }
            ...
            if (ld2.term.isVar()) {
              ...
              res=(id1<id2)? Comparison::LESS : (id1>id2)? Comparison::GREATER : Comparison::EQUAL;
            }
          }
        }
      }
  ...
  class IntermediateNode;
    ...
    public:
        ...
        {
            bySort.ensure((unsigned)Sorts::DefaultSorts::FIRST_USER_SORT);
            bySortTerms.ensure((unsigned)Sorts::DefaultSorts::FIRST_USER_SORT);
        }
        ...
        NodeIterator childBySort(TermList t)
        {
            ...
            if (SortHelper::tryGetResultSort(t, srt) && srt < (unsigned)Sorts::DefaultSorts::FIRST_USER_SORT && srt != (unsigned)Sorts::DefaultSorts:: SRT_DEFAULT) {
        ...
        void mightExistAsTop(TermList t)
        {
            ...
            if(SortHelper::tryGetResultSort(t,srt)){
                if(srt > (unsigned)Sorts::DefaultSorts::SRT_DEFAULT && srt < (unsigned)Sorts::DefaultSorts::FIRST_USER_SORT){
  ...
  public:
    ...
    NodeAlgorithm algorithm() const { return NodeAlgorithm::UNSORTED_LIST; }
  ...
  public:
    ...
    inline
    NodeAlgorithm algorithm() const { return NodeAlgorithm::SKIP_LIST; }
    inline
