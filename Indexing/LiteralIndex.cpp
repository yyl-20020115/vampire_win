...
void GeneratingLiteralIndex::handleClause(Clause* c, bool adding)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_BINARY_RESOLUTION_INDEX_MAINTENANCE);
...
void SimplifyingLiteralIndex::handleClause(Clause* c, bool adding)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_BACKWARD_SUBSUMPTION_INDEX_MAINTENANCE);
...
void FwSubsSimplifyingLiteralIndex::handleClause(Clause* c, bool adding)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_FORWARD_SUBSUMPTION_INDEX_MAINTENANCE);
...
void UnitClauseLiteralIndex::handleClause(Clause* c, bool adding)
{
  ...
  if(c->length()==1) {
    TimeCounter tc(Lib::TimeCounterUnit::TC_SIMPLIFYING_UNIT_LITERAL_INDEX_MAINTENANCE);
...
void NonUnitClauseLiteralIndex::handleClause(Clause* c, bool adding)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_NON_UNIT_LITERAL_INDEX_MAINTENANCE);
...
Literal* RewriteRuleIndex::getGreater(Clause* c)
{
  ...
  Literal* greater=
    ( comp== Comparison::GREATER ) ? (*c)[0] :
    ( comp== Comparison::LESS ) ? (*c)[1] : 0;
...
void RewriteRuleIndex::handleClause(Clause* c, bool adding)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_LITERAL_REWRITE_RULE_INDEX_MAINTENANCE);
