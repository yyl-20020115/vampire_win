...
void SuperpositionSubtermIndex::handleClause(Clause* c, bool adding)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_BACKWARD_SUPERPOSITION_INDEX_MAINTENANCE);
...
void SuperpositionLHSIndex::handleClause(Clause* c, bool adding)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_FORWARD_SUPERPOSITION_INDEX_MAINTENANCE);
...
void DemodulationSubtermIndex::handleClause(Clause* c, bool adding)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_BACKWARD_DEMODULATION_INDEX_MAINTENANCE);
...
void DemodulationLHSIndex::handleClause(Clause* c, bool adding)
{
  ...
  TimeCounter tc(Lib::TimeCounterUnit::TC_FORWARD_DEMODULATION_INDEX_MAINTENANCE);
