...
public:
  ...
  inline
  NodeAlgorithm algorithm() const { return Indexing::SubstitutionTree::NodeAlgorithm::UNSORTED_LIST; }
  inline
...
public:
  ...
  inline
  NodeAlgorithm algorithm() const { return Indexing::SubstitutionTree::NodeAlgorithm::SKIP_LIST; }
  inline
...
void SubstitutionTree::ensureLeafEfficiency(Leaf** leaf)
{
  ...
  if( (*leaf)->algorithm()== Indexing::SubstitutionTree::NodeAlgorithm::UNSORTED_LIST && (*leaf)->size()>5 ) {
...
void SubstitutionTree::ensureIntermediateNodeEfficiency(IntermediateNode** inode)
{
  ...
  if( (*inode)->algorithm()== Indexing::SubstitutionTree::NodeAlgorithm::UNSORTED_LIST && (*inode)->size()>3 ) {
