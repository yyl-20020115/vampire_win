  ...
  void ProvingHelper::runVampireSaturation(Problem& prb, const Options& opt)
{
  ...
  try {
    ...
    env.statistics->terminationReason=Statistics::TerminationReason::MEMORY_LIMIT;
    ...
    env.statistics->terminationReason=Statistics::TerminationReason::TIME_LIMIT;
    env.statistics->refutation=0;
  }
  catch(ActivationLimitExceededException&) {
    env.statistics->terminationReason=Statistics::TerminationReason::ACTIVATION_LIMIT;
    env.statistics->refutation=0;
  }
}
  ...
  void ProvingHelper::runVampireSaturationImpl(Problem& prb, const Options& opt)
{
  ...
  env.statistics->phase=Statistics::ExecutionPhase::SATURATION;
