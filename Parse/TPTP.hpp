...
private:
  ...
  public:
    ...
    explicit AtomicType(unsigned sortNumber)
      : Type(TypeTag::TT_ATOMIC), _sortNumber(sortNumber)
    {}
  ...
  public:
    ...
    ArrowType(Type* lhs,Type* rhs)
      : Type(TypeTag::TT_ARROW), _lhs(lhs), _rhs(rhs)
    {}
    /** the argument type */
  ...
  public:
    ...
    ProductType(Type* lhs,Type* rhs)
      : Type(TypeTag::TT_PRODUCT), _lhs(lhs), _rhs(rhs)
    {}
  ...
  static TheorySort getTheorySort(const Token tok) {
    ASS_REP(tok.tag == Tag::T_THEORY_SORT, tok.content);
    TheorySort ts;
  ...
  static TheoryFunction getTheoryFunction(const Token tok) {
    ASS_REP(tok.tag == Tag::T_THEORY_FUNCTION, tok.content);
    TheoryFunction tf;
