...
class Signature
{
 public:
  ...
  public:
    ...
    { return interpreted() && arity()==0 && fnType()->result()==(unsigned)Sorts::DefaultSorts::SRT_INTEGER; }
    /** Return true if symbol is a rational constant */
    inline bool rationalConstant() const
    { return interpreted() && arity()==0 && fnType()->result()== (unsigned)Sorts::DefaultSorts::SRT_RATIONAL; }
    /** Return true if symbol is a real constant */
    inline bool realConstant() const
    { return interpreted() && arity()==0 && fnType()->result()== (unsigned)Sorts::DefaultSorts::SRT_REAL; }
  ...
  public:
    ...
    : Symbol(val.toString(), 0, true), _intValue(val)
    {
      ...
      setType(OperatorType::getConstantsType((unsigned)Sorts::DefaultSorts::SRT_INTEGER));
    }
  ...
  public:
    ...
    : Symbol(val.toString(), 0, true), _ratValue(val)
    {
      ...
      setType(OperatorType::getConstantsType((unsigned)Sorts::DefaultSorts::SRT_RATIONAL));
    }
  ...
  public:
    ...
    : Symbol((env.options->proof() == Shell::Options::Proof::PROOFCHECK) ? "$to_real("+val.toString()+")" : val.toNiceString(), 0, true), _realValue(val)
    {
      ...
      setType(OperatorType::getConstantsType((unsigned)Sorts::DefaultSorts::SRT_REAL));
    }
  ...
  unsigned getFoolConstantSymbol(bool isTrue){ 
    if(!_foolConstantsDefined){
      ...
      getFunction(_foolFalse)->setType(OperatorType::getConstantsType((unsigned)Sorts::DefaultSorts::SRT_BOOL));
      _foolTrue = addFunction("$$true",0);
      getFunction(_foolTrue)->setType(OperatorType::getConstantsType((unsigned)Sorts::DefaultSorts::SRT_BOOL));
