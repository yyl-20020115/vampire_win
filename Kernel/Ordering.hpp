...
public:
  ...
  static bool isGorGEorE(Result r) { return (r == Result::GREATER || r == Result::GREATER_EQ || r == Result::EQUAL); }
  ...
  static Result reverse(Result r)
  {
    ...
    case Result::GREATER_EQ:
      return Result::LESS_EQ;
    case Result::LESS:
      return Result::GREATER;
    case Result::LESS_EQ:
      return Result::GREATER_EQ;
    case Result::EQUAL:
