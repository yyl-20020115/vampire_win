...
public:
   ...
   */
  unsigned count() const { return (unsigned)_sorts.length(); }
...
public:
  ...
  bool isAllDefault() const { return isSingleSortType((unsigned)Sorts::DefaultSorts::SRT_DEFAULT); }
