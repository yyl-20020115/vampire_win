...
MainLoopResult MainLoop::run()
{
  ...
  {
    return MainLoopResult(Statistics::TerminationReason::REFUTATION, rs.refutation);
  }
  catch(TimeLimitExceededException&)
  {
    return MainLoopResult(Statistics::TerminationReason::TIME_LIMIT);
  }
  catch(ActivationLimitExceededException&)
  {
    return MainLoopResult(Statistics::TerminationReason::ACTIVATION_LIMIT);
  }
