...
{
public:
  static unsigned getSort() { return (unsigned)Sorts::DefaultSorts::SRT_INTEGER; }
...
struct RationalConstantType {
  ...
  static unsigned getSort() { return (unsigned)Sorts::DefaultSorts::SRT_RATIONAL; }
...
{
public:
  static unsigned getSort() { return (unsigned)Sorts::DefaultSorts::SRT_REAL; }
...
public:
    ...
    enum class Interpretation
  {
    ...
    enum class IndexedInterpretation {
    FOR_NOW_EMPTY
  };
...
public:
  ...
  static unsigned numberOfFixedInterpretations() {
    return (unsigned)Interpretation::INVALID_INTERPRETATION;
  }
  ...
  static bool isPlus(Interpretation i){
    return i == Interpretation::INT_PLUS || i == Interpretation::RAT_PLUS || i == Interpretation::REAL_PLUS;
  }
