...
public:
  ...
  inline bool isOrdinaryVar() const { return tag() == TermTag::ORD_VAR; }
  /** the term contains a special variable as its head */
  inline bool isSpecialVar() const { return tag() == TermTag::SPEC_VAR; }
