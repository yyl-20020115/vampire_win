    ...
    if (n1 == numeric_limits<InnerType>::min()) {
      ...
      if (n2 == numeric_limits<InnerType>::min()) {
        return Comparison::LESS;
          ...
          {
              // compare the signed ones, making negative greater than positive
              int t = (int)Int::compare(n1.toInner(), n2.toInner());
              t = -t;
              return (Comparison)t;
          }
          else
...
Comparison RationalConstantType::comparePrecedence(RationalConstantType n1, RationalConstantType n2)
{
  ...
  try {
    ...
    if (n1==n2) { return Comparison::EQUAL; }
...
unsigned Theory::getArity(Interpretation i)
{
  ...
  ASS_L(i, Interpretation::INVALID_INTERPRETATION);
...
bool Theory::hasSingleSort(Interpretation i)
{
  ...
  switch(i) {
  case Interpretation::EQUAL:  // This not SingleSort because we don't know the sorts of its args
  case Interpretation::INT_TO_RAT:
  case Interpretation::INT_TO_REAL:
  case Interpretation::RAT_TO_INT:
  case Interpretation::RAT_TO_REAL:
...
bool Theory::isPolymorphic(Interpretation i)
{
  ...
  if ((unsigned)i >= numberOfFixedInterpretations()) { // indexed are all polymorphic (for now)
    return true;
  }
...
OperatorType* Theory::getConversionOperationType(Interpretation i)
{
  ...
  switch(i) {
  case Interpretation::INT_TO_RAT:
    from = (unsigned)Sorts::DefaultSorts::SRT_INTEGER;
    to = (unsigned)Sorts::DefaultSorts::SRT_RATIONAL;
    break;
  case Interpretation::INT_TO_REAL:
    from = (unsigned)Sorts::DefaultSorts::SRT_INTEGER;
    to = (unsigned)Sorts::DefaultSorts::SRT_REAL;
    break;
  case Interpretation::RAT_TO_INT:
    from = (unsigned)Sorts::DefaultSorts::SRT_RATIONAL;
    to = (unsigned)Sorts::DefaultSorts::SRT_INTEGER;
    break;
  case Interpretation::RAT_TO_REAL:
    from = (unsigned)Sorts::DefaultSorts::SRT_RATIONAL;
    to = (unsigned)Sorts::DefaultSorts::SRT_REAL;
    break;
  case Interpretation::REAL_TO_INT:
    from = (unsigned)Sorts::DefaultSorts::SRT_REAL;
    to = (unsigned)Sorts::DefaultSorts::SRT_INTEGER;
    break;
  case Interpretation::REAL_TO_RAT:
    from = (unsigned)Sorts::DefaultSorts::SRT_REAL;
...
void Theory::defineTupleTermAlgebra(unsigned arity, unsigned* sorts) {
  ...
  for (unsigned i = 0; i < arity; i++) {
    ...
    unsigned destructor;
    if (projSort ==(unsigned) Sorts::DefaultSorts::SRT_BOOL) {
...
bool Theory::isInterpretedPredicate(Literal* lit)
{
  ...
  if(lit->isEquality()){
    ...
    return (srt == (unsigned)Sorts::DefaultSorts::SRT_INTEGER || srt == (unsigned) Sorts::DefaultSorts::SRT_RATIONAL || srt == (unsigned)Sorts::DefaultSorts::SRT_REAL);
  }
...
vstring Theory::tryGetInterpretedLaTeXName(unsigned func, bool pred,bool polarity)
{
  ...
  switch(i){
  case Interpretation::EQUAL:return "a0 "+pol+"= a1";

  case Interpretation::INT_SUCCESSOR: return "a0++";
  case Interpretation::INT_UNARY_MINUS:
  case Interpretation::RAT_UNARY_MINUS:
  case Interpretation::REAL_UNARY_MINUS: return "-a0";

  case Interpretation::INT_GREATER: return "a0 "+pol+"> a1";
  case Interpretation::INT_GREATER_EQUAL: return "a0 "+pol+"\\geq a1";
  case Interpretation::INT_LESS: return "a0 "+pol+"< a1";
  case Interpretation::INT_LESS_EQUAL: return "a0 "+pol+"\\leq a1";
  case Interpretation::INT_DIVIDES: return "a0 "+pol+"\\| a1"; // check?

  case Interpretation::RAT_GREATER: return "a0 "+pol+"> a1";
  case Interpretation::RAT_GREATER_EQUAL: return "a0 "+pol+"\\geq a1";
  case Interpretation::RAT_LESS: return "a0 "+pol+"< a1";
  case Interpretation::RAT_LESS_EQUAL: return "a0 "+pol+"\\leq a1";

  case Interpretation::REAL_GREATER: return "a0 "+pol+"> a1";
  case Interpretation::REAL_GREATER_EQUAL: return "a0 "+pol+"\\geq a1";
  case Interpretation::REAL_LESS: return "a0 "+pol+"< a1";
  case Interpretation::REAL_LESS_EQUAL: return "a0 "+pol+"\\leq a1";

  case Interpretation::INT_PLUS: return "a0 + a1";
  case Interpretation::INT_MINUS: return "a0 - a1";
  case Interpretation::INT_MULTIPLY: return "a0 \\cdot a1";

  case Interpretation::RAT_PLUS: return "a0 + a1";
  case Interpretation::RAT_MINUS: return "a0 - a1";
  case Interpretation::RAT_MULTIPLY: return "a0 \\cdot a1";
  case Interpretation::RAT_QUOTIENT: return "a0 / a1";

  case Interpretation::REAL_PLUS: return "a0 + a1";
  case Interpretation::REAL_MINUS: return "a0 - a1";
  case Interpretation::REAL_MULTIPLY: return "a0 \\cdot a1";
  case Interpretation::REAL_QUOTIENT: return "a0 / a1";
