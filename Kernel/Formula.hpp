...
public:
  ...
  explicit Formula (bool value)
    : _connective(value ? Connective::_TRUE : Connective::_FALSE)
  {
...
{
public:
  explicit NamedFormula(vstring name) : Formula(Connective::NAME), _name(name) {}
 ...
 public:
  ...
  QuantifiedFormula(Connective con, VarList* vs, SortList* ss, Formula* arg)
    : Formula(con),
      ...
      _arg(arg)
  {
    ASS(con == Connective::FORALL || con == Connective::EXISTS);
    ASS(vs);
...
public:
  ...
  explicit BinaryFormula (Connective con,Formula* lhs,Formula* rhs)
    : Formula(con),
      ...
      _right(rhs)
  {
    ASS(con == Connective::IFF || con == Connective::XOR || con == Connective::IMP);
  }
 ...
 public:
  JunctionFormula (Connective con, FormulaList* args)
    : Formula(con),
      _args(args)
  {
    ASS(con == Connective::AND || con == Connective::OR);
...
{
  ASS(_connective == Connective::FORALL || _connective == Connective::EXISTS);
...
{
  ASS(_connective == Connective::NOT);
...
{
  ASS(_connective == Connective::AND || _connective == Connective::OR);
...
{
  ASS(_connective == Connective::LITERAL);
...
{
  ASS(_connective == Connective::IFF || _connective == Connective::XOR || _connective == Connective::IMP);
...
{
  ASS(_connective == Connective::BOOL_TERM);
